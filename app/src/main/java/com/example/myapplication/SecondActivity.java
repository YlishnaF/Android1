    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbCapital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String urlStr = String.format("https://ru.wikipedia.org/wiki/%s", rbCapital.getText().toString());
        ...
        rbHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String urlStr = String.format("https://ru.wikipedia.org/wiki/%s", rbHome.getText().toString());
                Uri uri = Uri.parse(urlStr);
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
        }
